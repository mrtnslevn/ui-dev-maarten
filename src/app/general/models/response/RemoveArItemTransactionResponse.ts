...
export interface RemoveArItemTransactionResponse extends GlobalResponse {
    transaction_details: RemoveArItemTransactionData[]
}

export interface RemoveArItemTransactionData {
    ar_item_id: number,
    order_date: string,
